...
const Home = () => {
  ...
  return (
    <div>
      ...
      <div className="container-fluid bg-back py-5">
          ...
          <div className="row">
...

            {
              service.map((el, index) => {
                ...
                return <div onClick={card} className="col-4 py-3 cursor">
                  <div className="service-card">
                    ...
                    <div class="service-card_content">
                      ...
                      <h4 class="service-card_title h5"><a href="service-details.html">{el.serviceName}</a></h4>
                      <p class="service-card_text">{el.decription}</p>
                      <h5 className="f-28 mb-0"><sup className="f-13">$</sup>{el.cost}</h5>
                      <a href="service-details.html" class="link-btn">Read More <HiOutlineArrowNarrowRight /></a>
                    </div>
